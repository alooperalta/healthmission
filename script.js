...
<header>\
    <div class="title">\
        <h2><a href="single.html">'+ heading[i] + '</a></h2>\
        <p>'+ subHeading[i] +'</p>\
    </div>\
    <div class="meta">\
...
<a href="single.html" class="image featured"><img src="'+ image[i] +'" alt="" /></a>\
<p>'+ content[i] +'</p>\
<footer>\
    <ul class="actions">\
...
<header>\
    <h3><a href="single.html">'+ heading[i] +'</a></h3>\
    <time class="published">'+ date[i] +'</time>\
    <a href="#" class="author"><img src="'+authorImage[i]+'" alt="" /></a>\
</header>\
<a href="single.html" class="image"><img src="'+image[i]+'" alt="" /></a>\
</article>';
}
...
postsNoImage.innerHTML += '<li>\
        <article>\
            ...
            <a href="single.html" class="image"><img src="'+ authorImage[i] +'" alt="" /></a>\
        </article>\
    </li>';
}
